...
export default function ThreePlans1 ({
  plans = null,
}) {
  ...
  const defaultPlans = [
    {
      name: t("pricing.card3.title"),
      price: "2000 FCFA",
      duration: "",
      mainFeature: "",
      features: [t("pricing.card3.line"), t("pricing.card3.line1"), t("pricing.card3.line2"), t("pricing.card3.line3"), t("pricing.card3.line4")],
    },
  ];
