...
export default function ThreePlans ({
  ...
  const subheading = t("pricing.title");
  const heading = t("pricing.heading");
  const description = t("pricing.description");
  const   primaryButtonText = t("pricing.button");


  const defaultPlans = [
    {
      name: t("pricing.card.title"),
      price: "6000 FCFA",
      duration: "",
      mainFeature: "",
      features: [t("pricing.card.line"), t("pricing.card.line1"), t("pricing.card.line2"), t("pricing.card.line3")],
    },
    {
      name: t("pricing.card1.title"),
      price: "500 FCFA",
      duration: "",
      mainFeature: "",
      features: [t("pricing.card1.line"), t("pricing.card1.line1"), t("pricing.card1.line2"), t("pricing.card1.line3"), t("pricing.card1.line4"), t("pricing.card1.line5")],
      featured: true,
    },
    {
      name: t("pricing.card2.title"),
      price: "1000 FCFA",
      duration: "",
      mainFeature: "",
      features: [t("pricing.card2.line"), t("pricing.card2.line1"), t("pricing.card2.line2"), t("pricing.card2.line3"), t("pricing.card2.line4")],
    },
  ];
        ...
        <PlansContainer>
          {plans.map((plan, index) => (
            <Plan key={index} featured={plan.featured}>
              ...
              <PlanAction>
                <BuyNowButton css={!plan.featured && highlightGradientsCss[index]} href="/#contact">{primaryButtonText}</BuyNowButton>
              </PlanAction>
            </Plan>
          ))}
          <DecoratorBlob/>
